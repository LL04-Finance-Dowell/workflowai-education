...
const VerificationPage = () => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      try {
        auth_users = JSON.parse(
          paramsPassed.getAll("username")[0].replaceAll("'", '"')
        );
      } catch (error) {
      ...
      sanitizedDataToPost.org_name = isPublicUser ? "public" : org_name;
