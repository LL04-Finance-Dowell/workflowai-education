...
import InitialCongiguration from "./pages/InitialConfiguration/InitialCongiguration";
...
function App() {
  ...
  const clientVerUrlRef = useRef(
    "https://ll04-finance-dowell.github.io/workflowai.online/"
  );
  const betaVerUrlRef = useRef(
  ...
  return (
    <Suspense fallback={"Language Loading ..."}>
      <Routes>
        ...
        <Route path={"/intialConfig"} element={<InitialCongiguration />} />
